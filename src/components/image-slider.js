...
const slideImages = [
  ...
  require(`../images/image-slider.jpg`),
  require(`../images/image-slider.jpg`),
  require(`../images/image-slider.jpg`)
]
...
class Slideshow extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      txt3: ['Bring about your great customer', 'testimonies...']
        ...
        <Slide {...properties}>
          <Grid style={{ backgroundImage: `url(${slideImages[0]})`, height: '100vh', backgroundSize: 'cover' }}>
            <Grid container xs='12' style={{ height: '100vh', backgroundSize: 'cover', position: 'relative' }}>
              ...
              <Grid item xs='12' style={{ position: 'relative', top: '30%', right: '15%', color: 'white' }}>
          ...
          <Grid style={{ backgroundImage: `url(${slideImages[1]})`, height: '100vh', backgroundSize: 'cover' }}>
            <Grid container xs='12' style={{ height: '100vh', backgroundSize: 'cover', position: 'relative' }}>
              ...
              <Grid item xs='7' />
              <Grid item xs='5' style={{ position: 'relative', top: '30%', right: '15%', color: 'white' }}>
          ...
          <Grid item xs={12} style={{ backgroundImage: `url(${slideImages[2]})`, height: '100vh', backgroundSize: 'cover' }}>
            <Grid container xs='12' style={{ height: '100vh', backgroundSize: 'cover', position: 'relative' }}>
              ...
              <Grid item xs='12' style={{ position: 'relative', top: '30%', right: '10%', color: 'white' }}>
