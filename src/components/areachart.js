...
class AreaChart extends Component {
  ...
  render () {
    return (
      <Grid>
        <Typography align='center' style={{ fontSize: '300%', fontWeight: 'bold' }}>Bring out the WOW!!</Typography>
        <Typography align='center' style={{ fontSize: '200%' }}>  by visualizing it</Typography>
        <br />
        <Line height='156%' data={this.state.data} options={this.options} />
      </Grid>
    )
  }
}
